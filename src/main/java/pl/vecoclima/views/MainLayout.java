...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Sklep", LineAwesomeIcon.SHOPPING_CART_SOLID.create(), SklepView.class), //

                new MenuItemInfo("Kontakt", LineAwesomeIcon.PHONE_SOLID.create(), KontaktView.class), //

                new MenuItemInfo("Zarządzanie", LineAwesomeIcon.LOCK_SOLID.create(), ZarządzanieView.class), //
